...
import {  FiCheckCircle, FiBook, FiUsers } from "react-icons/fi";  
...
export const ON_HOLD_REASONS = [
  {
    id: 1,
    name: "Child is above the age of 18",
    value: "child-is-above-the-age-of-18",
  },
  {
    id: 2,
    name: "Document in regional language",
    value: "document-in-regional-language",
  },
  {
    id: 3,
    name: "Parent Name not matching",
    value: "parent-name-not-matching",
  },
];
...
export const medicalproBranding = { data: [], teams: [], leaders: [] };
